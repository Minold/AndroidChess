package com.chess.cs213.chessandroid59;
...
import static com.chess.cs213.chessandroid59.chess.Chess.findKingPosition;
import static com.chess.cs213.chessandroid59.chess.Chess.isCheckMate;
import static com.chess.cs213.chessandroid59.chess.Chess.isKingInCheck;
import static com.chess.cs213.chessandroid59.chess.Chess.setUpGame;

import static com.chess.cs213.chessandroid59.chess.Chess.validMoves;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.undo) {
            if (lastAI){
                Toast.makeText(this, "undo cannot be mae for AI moves", Toast.LENGTH_SHORT).show();
                return true;
            } else {
            ...
            lastAI=true;
            return true;
        } else if (item.getItemId() == R.id.resign) {
    ...
    public void onClick(View v){
        ...
        if (firstClick) {
            if (chessBoard.grid[clickedSpot.getXCoordinate()][clickedSpot.getYCoordinate()].isEmpty()) {
                ...
                return;
            }else if (!canBlockCheck(clickedSpot) && !(chessBoard.grid[clickedSpot.getXCoordinate()][clickedSpot.getYCoordinate()].getPiece() instanceof King) && ((whiteTurn && isKingInCheck(0, findKingPosition(0, chessBoard), chessBoard)) || (!whiteTurn && isKingInCheck(1, findKingPosition(1, chessBoard), chessBoard)))){
    ...
    public void pawnPick(View v){
        ...
        } else if (v.getId() == R.id.pawn2rook) {
        ...
        } else if (v.getId() == R.id.pawn2bishop) {
        ...
        } else if (v.getId() == R.id.pawn2knight) {
